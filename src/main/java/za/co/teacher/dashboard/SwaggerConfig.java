package za.co.teacher.dashboard;
...
@Configuration("teacher.dashboard.SwaggerConfig")
@EnableSwagger2
public class SwaggerConfig {
    ...
    public SwaggerConfig(
            @Qualifier("teacher.dashboard.ApplicationConfig") ApplicationConfig applicationConfig) {
