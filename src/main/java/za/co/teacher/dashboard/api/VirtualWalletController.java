...
import za.co.teacher.dashboard.dto.*;
import za.co.teacher.dashboard.entity.CustomerEntity;
import za.co.teacher.dashboard.entity.TransactionEntity;
import za.co.teacher.dashboard.exceptions.BadRequestException;
import za.co.teacher.dashboard.exceptions.ForbiddenException;
import za.co.teacher.dashboard.exceptions.NotFoundException;
import za.co.teacher.dashboard.exceptions.UnauthorizedException;
import za.co.teacher.dashboard.repository.AccountRepository;
import za.co.teacher.dashboard.repository.CustomerRepository;
import za.co.teacher.dashboard.repository.TransactionRepository;
...
@RestController("api.VirtualWalletController")
...
public class VirtualWalletController {
    ...
    public VirtualWalletController(
            @Qualifier("teacher.dashboard.AccountRepository") AccountRepository accountRepository,
            @Qualifier("teacher.dashboard.CustomerRepository") CustomerRepository customerRepository,
            @Qualifier("teacher.dashboard.TransactionRepository") TransactionRepository transactionRepository) {
